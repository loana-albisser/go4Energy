    ...
    private void createQuestionTable(SQLiteDatabase db) throws SQLException {
        ...
        String CREATE_INIT_VALUES =
                "INSERT INTO "+this.TABLE_QUESTION+" "+
                        ...
                        "UNION SELECT 4, 1, 'Wie kann man beim Autofahren kräftig Treibstoff sparen?','http://www.energieschweiz.ch/de-ch/mobilitaet/effizientes-fahren/ecodrive.aspx ', 0, 1 "+
