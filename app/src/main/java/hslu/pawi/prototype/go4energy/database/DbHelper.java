...
public class DbHelper extends SQLiteOpenHelper {
    ...
    private void createQuestionTable(SQLiteDatabase db) throws SQLException {
        String CREATE_QUESTION_TABLE = "CREATE TABLE "+this.TABLE_QUESTION+" ("+
                ...
                "FOREIGN KEY("+this.COLUMN_CATEGORY+") REFERENCES "+this.TABLE_CATEGORY+"("+COLUMN_ID+")" +
        ...
        String CREATE_INIT_VALUES =
                "INSERT INTO "+this.TABLE_QUESTION+" "+
                        ...
                        "UNION SELECT 4, 1, 'Mächtig beim Autofahren Treibstoff sparen mit?','http://www.energieschweiz.ch/de-ch/mobilitaet/effizientes-fahren/ecodrive.aspx ', 0, 1"+
                        ...
                        "UNION SELECT 7, 2, 'Wie gross ist der Heizwert von Pellet aus Spänen, Sägemehl?','energeia Nr. 4 / 2015 Newsletter des Bundesamts für Energie BFE','http://www.holzenergie.ch/uploads/tx_ttproducts/datasheet/403energieinhalt_graueEnergie_DFI_05.pdf.', 0, 1"+
    ...
    private void createAnswerTable(SQLiteDatabase db) throws SQLException {
        String CREATE_ANSWER_TABLE = "CREATE TABLE "+this.TABLE_QUESTION+" ("+
                this.COLUMN_ID + " INTEGER PRIMARY KEY AUTOINCREMENT, "+
